...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Operator ++ dla macierzyA:" << std::endl;  
    ++matrixA;
    matrixA.print();
    std::cout << std::endl;

    std::cout << "Operator -- dla maceirzyB:" << std::endl;
    --matrixB;
    matrixB.print();
    std::cout << std::endl;

    std::cout << "MacierzA == maceirzB:" << std::endl;
    std::cout << (matrixA==matrixB) << std::endl;

    std::cout << std::endl;

    std::cout << "MacierzA =! macierzB:" << std::endl;
	std::cout << (matrixA!=matrixB) << std::endl;
